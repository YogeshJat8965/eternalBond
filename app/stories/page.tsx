          ...
          <div className="grid md:grid-cols-2 gap-8">
            {stories.map((story, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 border border-pink-100"
              >
                <div className="relative h-80 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 text-white">
                    <h3 className="text-3xl font-bold mb-2">{story.couple}</h3>
